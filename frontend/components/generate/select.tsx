          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-2">
                ...
                <button
                  type="button"
                  className="ml-2 text-sm inline-flex items-center rounded-md border border-transparent border-primary px-5 py-1 font-medium text-primary hover:primary-darker cursor-pointer"
                  onClick={() => {
                    console.log("clicked");
