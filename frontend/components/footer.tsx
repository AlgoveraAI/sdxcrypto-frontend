...
const navigation = {
    ...
    community: [
      ...
      { name: 'Youtube', href: 'https://www.youtube.com/channel/UC2A5iUpP6k52ZZmC8LFj1IA' },
    ],
    more: [
      ...
      <footer className="bg-white" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl pt-12 pb-8 px-4 sm:px-6  lg:px-8">
          <div className="xl:grid xl:grid-cols-2 xl:gap-8">
            <div className="space-y-8 xl:col-span-1 w-3/4">
              ...
              <p className="text-base text-gray-500">
                Algovera allows anyone to build AI workflows using AI legos. Start monetizing your creations instantly.
              </p>
            </div>
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 text-center sm:text-left">&copy; 2022 Algovera, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
