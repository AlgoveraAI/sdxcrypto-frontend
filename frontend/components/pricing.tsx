              ...
              <div className="flex-1 bg-white px-6 py-8 lg:p-12">
                <div className="mt-8">
                  <div className="flex items-center">
                    <h4 className="flex-shrink-0 bg-white pr-4 text-base font-semibold text-primary">
                ...
                <div className="mt-6">
                  <div className="rounded-md shadow">
                    <a
                      ...
                      className="flex items-center justify-center rounded-md border border-transparent bg-gray-800 px-5 py-3 text-base font-medium text-white hover:bg-gray-900 cursor-pointer"
                    >
                      Buy Credits
                    </a>
                  </div>
